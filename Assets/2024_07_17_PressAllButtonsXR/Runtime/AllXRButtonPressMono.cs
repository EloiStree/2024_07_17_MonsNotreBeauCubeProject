...
public class AllXRButtonPress : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        inputActions.AllButtons.LeftTopButton.Enable();
        inputActions.AllButtons.LeftDownButton.Enable();
        inputActions.AllButtons.RightTopButton.Enable();
        inputActions.AllButtons.RightDownButton.Enable();
        inputActions.AllButtons.TriggerLeft.Enable();
        inputActions.AllButtons.TriggerRight.Enable();
        inputActions.AllButtons.GrabLeft.Enable();
        inputActions.AllButtons.GrabRight.Enable();
